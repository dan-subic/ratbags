...
In Ratbags!, PCs can make create magical stuff. For the purposes of these rules, they are called _Crafts_.


## Requirements

Creating a _Craft_ requires:
...
A [**Relic**](/core-rules/magic.html#relics) is a special type of _Craft_. The main difference is how it's made- where other _Crafts_ are made in a wizarding lab, a **Relic** ia made by beseeching a powerful spirit.
...
All other requirements for ordinary _Crafts_ are waived.
...
To create a **Relic**, follow the normal procedure for creating a _Craft_. Instead of rolling for a twist, treat it as if the Crafter had rolled a 2- thus, a **Relic** always has a desire.
